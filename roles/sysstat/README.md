...
The machine needs to be prepared. In CI this is done using [`molecule/default/prepare.yml`](https://github.com/robertdebock/ansible-role-sysstat/blob/master/molecule/default/prepare.yml):
...
[Apache-2.0](https://github.com/robertdebock/ansible-role-sysstat/blob/master/LICENSE).
