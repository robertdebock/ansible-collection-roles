...
The machine needs to be prepared. In CI this is done using [`molecule/default/prepare.yml`](https://github.com/robertdebock/ansible-role-docker/blob/master/molecule/default/prepare.yml):
...
The default values for the variables are set in [`defaults/main.yml`](https://github.com/robertdebock/ansible-role-docker/blob/master/defaults/main.yml):
...
[Apache-2.0](https://github.com/robertdebock/ansible-role-docker/blob/master/LICENSE).
