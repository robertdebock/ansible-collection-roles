...
This example is taken from [`molecule/default/converge.yml`](https://github.com/robertdebock/ansible-role-vagrant/blob/master/molecule/default/converge.yml) and is tested on each push, pull request and release.
...
The default values for the variables are set in [`defaults/main.yml`](https://github.com/robertdebock/ansible-role-vagrant/blob/master/defaults/main.yml):
...
![dependencies](https://raw.githubusercontent.com/robertdebock/ansible-role-vagrant/png/requirements.png "Dependencies")
...
[Apache-2.0](https://github.com/robertdebock/ansible-role-vagrant/blob/master/LICENSE).
