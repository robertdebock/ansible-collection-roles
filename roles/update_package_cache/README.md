...
- name: Converge
  ...
  roles:
    - role: robertdebock.roles.roles.update_package_cache
```
...
![dependencies](https://raw.githubusercontent.com/robertdebock/ansible-role-update_package_cache/png/requirements.png "Dependencies")
